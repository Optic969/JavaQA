package Homework.HW5DeclaringAndCallingMethods.HW5_2;

public class StudentTest {
    public static void main(String[] args) {

        Student studen1 = new Student(100,"Ivan","Ivanov",1995,6,8,9);
        Student studen2 = new Student(200,"Fedor","Petrov",1996,6,8,4);
        Student studen3 = new Student(300,"Sasha","Sidarov",1997,6,8,2);
...
Student(int StudentTiket,String Name,String SecondName, int Year,double AVGMathematic,double AVGEconomic,double AVGEnglish){
